...
const Card = () => {
  ...
  return (
    <div className='card'>
          ...
          <div className="card__body">
            ...
            <div className="card__ratings">
              <form onSubmit={formSubmitHandler}>
                <div className="rating__radio-group">
                  <div className="rating__radio">
                    <input type="radio" name="rating" id="one" value='1' onChange={ratingHandler} />
                    <label className='rating__label' htmlFor="one">1</label>
                  </div>
                  <div className="rating__radio">
                    <input type="radio" name="rating" id="two" value='2' onChange={ratingHandler} />
                    <label className='rating__label' htmlFor="two">2</label>
                  </div>
                  <div className="rating__radio">
                    <input type="radio" name="rating" id="three" value='3' onChange={ratingHandler} />
                    <label className='rating__label' htmlFor="three">3</label>
                  </div>
                  <div className="rating__radio">
                    <input type="radio" name="rating" id="four" value='4' onChange={ratingHandler} />
                    <label className='rating__label' htmlFor="four">4</label>
                  </div>
                  <div className="rating__radio">
                    <input type="radio" name="rating" id="five" value='5' onChange={ratingHandler} />
                    <label className='rating__label' htmlFor="five">5</label>
                  </div>

                </div>
                <button className='button' type="submit" data-btn_variant='primary'>SUBMIT</button>
              </form>
            </div>
          </div>
        </div>
      ...
      {isSubmit && (
        <div className="card__content">
          <div className="card__header " data-header_variant='center'>
          ...
          <div className="card__body">
            <div className="card__rating-alert">
              <p>You selected {rating} out of 5</p>
            </div>
            <div className="card__description" data-description_variant='center'>
              <h1>Thank you!</h1>
